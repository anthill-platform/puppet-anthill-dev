define anthill_environment::version (
  ...
  anthill::service::version { "${anthill_environment::service_name}_${api_version}":
    service_name                                => $anthill_environment::service_name,
    server_name                                 => $anthill_environment::server_name,
    api_version                                 => $api_version,
    package_name                                => $anthill_environment::package_name,
